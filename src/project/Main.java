...
public class Main {
    public static void main(String[] args) {
        ...
        taskManager.updateSubtask(3, TaskStatus.DONE, new Subtask("Выровнять участок", "Заказать трактор для выравнивания участка", 2));
...
//        Считывание и формирование менеджера из файла
        FileBackedTaskManager taskManagerFromFile = Managers.loadFromFile(new File(CSVTaskUtil.getBackupPath()
